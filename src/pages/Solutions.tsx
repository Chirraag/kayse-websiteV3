...
import { ArrowRight, MessageCircle, Database, Bot, Users, CheckCircle2 } from 'lucide-react';
...
<section className="relative py-24 sm:py-32 overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    <motion.div
      ...
      animate={{ scale: [1, 1.2, 1], opacity: [0.1, 0.15, 0.1], rotate: [0, 45, 0] }}
      transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
    />
    <motion.div
      className="absolute bottom-1/4 right-1/4 w-[35rem] h-[35rem] bg-[#0077ff]/08 rounded-[60%] blur-[80px]"
      animate={{ scale: [1, 1.1, 1], opacity: [0.08, 0.12, 0.08], rotate: [0, -30, 0] }}
  ...
  <div className="container mx-auto px-4 md:px-8 relative z-20">
    <div className="max-w-4xl mx-auto text-center">
      ...
      >
        Three integrated technologies working together to solve your biggest challenges
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        {/* Voice AI Section */}
        <section className="relative py-24 sm:py-32 overflow-hidden" id="voice-ai">
          <div className="absolute inset-0">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 tracking-[-0.03em] leading-[1.1] text-white">
                  <span className="text-white">Human-like</span> <span className="bg-gradient-to-r from-white via-[#3e9dff] via-[#3e9dff] to-white bg-clip-text text-transparent" style={{
                    backgroundSize: "200% 100%",
                    backgroundPosition: "60% 0",
                  }}>Voice AI</span> <span className="text-white">for Scaled Communication</span>
                </h2>
                <p className="text-lg text-white/80 mb-8 leading-relaxed font-light">
                  The average law firm spends 12-15 hours per week per staff member on routine client communications. Kayse's Voice AI transforms client relationships with:
                </p>
                ...
                <p className="text-lg font-semibold text-accent mb-6">
                  Reduce staff communication workload by 12-15 hours weekly while improving satisfaction.
                </p>
                <blockquote className="p-8 rounded-[2.5rem] overflow-hidden backdrop-blur-xl mb-8 relative"
                  style={{
                  ...
                  "Our paralegals used to spend 40% of their time on routine calls. Kayse's Voice AI freed them to focus on higher-value work while improving client satisfaction."
                  <div className="flex items-center mt-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/70 text-sm">Legal Operations Director</div>
                    </div>
                  </div>
                </blockquote>
                <a 
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden" id="sentiment-analysis">
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 tracking-[-0.03em] leading-[1.1] text-white">
                  <span className="text-white">Proactive</span> <span className="bg-gradient-to-r from-white via-[#3e9dff] via-[#3e9dff] to-white bg-clip-text text-transparent" style={{
                    backgroundSize: "200% 100%",
                    backgroundPosition: "60% 0",
                  }}>Retention</span> <span className="text-white">through Analysis</span>
                </h2>
                <p className="text-lg text-white/80 mb-8 leading-relaxed font-light">
                  Client satisfaction decreases by 32% when updates are delayed more than 72 hours. Our proprietary sentiment analysis:
                </p>
                <ul className="space-y-4 mb-8 text-left">
                  {[
                ...
                <p className="text-lg font-semibold text-accent mb-6">
                  Reduce client attrition by up to 40% or greater through early intervention.
                </p>
                <blockquote className="p-8 rounded-[2.5rem] overflow-hidden backdrop-blur-xl mb-8 relative"
                  style={{
                    background: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(59,130,246,0.1) 50%, rgba(147,51,234,0.1) 100%)',
                  ...
                  "The sentiment analysis identified patterns we never would have noticed. We now intervene with potentially dissatisfied clients before they consider changing representation."
                  <div className="flex items-center mt-4">
                    <img 
                    ...
                    <div>
                      ...
                      <div className="text-white/70 text-sm">Managing Partner</div>
                    </div>
                  </div>
                </blockquote>
                <a 
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden" id="client-portal">
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-block mb-4 px-6 py-2 rounded-xl bg-gradient-to-r from-white/10 via-white/[0.07] to-transparent backdrop-blur-md border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] transition-all duration-300">
                  <span className="text-white font-medium">Mobile Client Portal</span>
                </div>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 tracking-[-0.03em] leading-[1.1] text-white">
                  <span className="text-white">Client</span> <span className="bg-gradient-to-r from-white via-[#3e9dff] via-[#3e9dff] to-white bg-clip-text text-transparent" style={{
                    backgroundSize: "200% 100%",
                    backgroundPosition: "60% 0",
                  }}>Portal</span> <span className="text-white">That Clients Love</span>
                </h2>
                <p className="text-lg text-white/80 mb-8 leading-relaxed font-light">
                  Generic client portals achieve only 23% adoption. Kayse's specialized portal reaches 70%+ adoption because it's designed specifically for legal clients. Our portal provides:
                </p>
                <ul className="space-y-4 mb-8 text-left">
                  {[
                ...
                <blockquote className="p-8 rounded-[2.5rem] overflow-hidden backdrop-blur-xl mb-8 relative"
                  ...
                  "Our clients love the portal—it answers their common questions without calling us. Even better, they can talk to the AI about their case from inside the client portal!"
                  <div className="flex items-center mt-4">
                    <img 
                    ...
                    <div>
                      ...
                      <div className="text-white/70 text-sm">Client Services Manager</div>
                    </div>
                  </div>
                </blockquote>
                <a 
        ...
        <section className="relative py-24 sm:py-32 pb-32 overflow-hidden" id="integrated-approach">
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center mb-16">
              <div className="inline-block mb-4 px-6 py-2 rounded-xl bg-gradient-to-r from-white/10 via-white/[0.07] to-transparent backdrop-blur-md border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] transition-all duration-300">
                <span className="text-white font-medium">Integrated Approach</span>
              </div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 tracking-[-0.03em] leading-[1.1] text-white">
                <span className="text-white">The Power of</span> <span className="bg-gradient-to-r from-white via-[#3e9dff] via-[#3e9dff] to-white bg-clip-text text-transparent" style={{
                  backgroundSize: "200% 100%",
                  backgroundPosition: "60% 0",
                }}>Integration</span>
              </h2>
              <p className="text-lg text-white/80 leading-relaxed font-light mb-8">
                While each component delivers significant value individually, the true power comes from seamless integration:
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              {[
                ...
                >
                  ...
                  <p className="text-white/90 text-center text-sm relative z-10">{item}</p>
                </motion.div>
              ))}
            </div>
            ...
            <div className="text-center">
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <span className="relative text-white">See How It All Works Together</span>
                  <ArrowRight className="w-5 h-5 text-white group-hover:translate-x-1 transition-transform duration-200" />
                </a>
              </motion.div>
            </div>
