...
import { ArrowRight, CheckCircle2, AlertCircle, X, Briefcase, Users, Building2 } from 'lucide-react';
...
const PracticeAreas: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'litigation', label: 'Litigation', icon: <Briefcase className="w-4 h-4" />, count: 2 },
    { id: 'personal', label: 'Personal', icon: <Users className="w-4 h-4" />, count: 6 },
    { id: 'business', label: 'Business', icon: <Building2 className="w-4 h-4" />, count: 2 }
  ];
  ...
  const practiceAreas = [
    {
      ...
      testimonial: "Handling 2,500+ Camp Lejeune cases, Kayse's Voice AI now manages 83% of inquiries. The retention improvement paid for the system within two months.",
      author: "Jennifer R., Mass Tort Manager",
      stats: { retention: "+27%", timeSaved: "30hrs/week", satisfaction: "+31 NPS" }
    },
    {
      id: "personal-injury",
      ...
      testimonial: "Before Kayse, we missed 35% of after-hours calls. Now our AI captures these leads and begins intake immediately. Our conversion rate increased by 41%.",
      author: "Michael T., Personal Injury Attorney",
      stats: { retention: "+22%", timeSaved: "25hrs/week", satisfaction: "+28 NPS" }
    },
    {
      id: "disability",
      ...
      testimonial: "Our disability clients often have anxiety about their cases. Kayse's Voice AI now handles these calls with empathy while our staff focuses on advancing cases. Our satisfaction scores increased 47%.",
      author: "Sarah M., Disability Law Associate",
      stats: { retention: "+34%", timeSaved: "28hrs/week", satisfaction: "+47 NPS" }
    },
    {
      id: "employment",
      ...
      testimonial: "Employment cases require careful documentation. Kayse has transformed how we manage client relationships, automating updates while ensuring clients feel supported. We've reduced administrative time by 28 hours weekly.",
      author: "David L., Employment Law Partner",
      stats: { retention: "+19%", timeSaved: "28hrs/week", satisfaction: "+24 NPS" }
    },
    {
      id: "immigration",
      ...
      testimonial: "Our clients come from diverse backgrounds with varying English proficiency. Kayse's multilingual capabilities have dramatically improved communication. The automated document collection alone has saved us countless hours.",
      author: "Maria G., Immigration Attorney",
      stats: { retention: "+31%", timeSaved: "35hrs/week", satisfaction: "+38 NPS" }
    },
    {
      id: "workers-comp",
      ...
      testimonial: "Workers' compensation cases involve constant communication with clients, medical providers, and insurance companies. Kayse has automated much of this process, ensuring nothing falls through the cracks.",
      author: "Robert J., Workers' Comp Attorney",
      stats: { retention: "+25%", timeSaved: "22hrs/week", satisfaction: "+29 NPS" }
    },
    {
      id: "criminal",
      ...
      testimonial: "Criminal cases often start with urgent calls at all hours. Kayse ensures we never miss these critical moments, while providing immediate guidance until our attorneys can engage.",
      author: "Thomas W., Criminal Defense Attorney",
      stats: { retention: "+21%", timeSaved: "24hrs/week", satisfaction: "+26 NPS" }
    },
    {
      id: "family",
      title: "Family Law",
      ...
      testimonial: "Family law clients often need reassurance outside business hours. Kayse provides that support while efficiently gathering documentation. Our clients feel better supported, and our team spends less time on administrative tasks.",
      author: "Jennifer P., Family Law Attorney",
      stats: { retention: "+29%", timeSaved: "26hrs/week", satisfaction: "+35 NPS" }
    },
    {
      id: "bankruptcy",
      ...
      testimonial: "Bankruptcy clients are often overwhelmed by documentation requirements. Kayse has transformed our practice by automating collection and providing 24/7 support. Our preparation time decreased by 35% while improving accuracy.",
      author: "Michael R., Bankruptcy Attorney",
      stats: { retention: "+18%", timeSaved: "20hrs/week", satisfaction: "+22 NPS" }
    },
    {
      id: "estate",
      ...
      testimonial: "Estate planning requires building lasting relationships. Kayse helps us maintain these connections through automated check-ins and life event monitoring. Our client retention has increased 28% since implementation.",
      author: "Elizabeth T., Estate Planning Attorney",
      stats: { retention: "+28%", timeSaved: "18hrs/week", satisfaction: "+32 NPS" }
    }
  ];
...
<section className="relative py-24 sm:py-32 overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    <motion.div
      ...
      animate={{ scale: [1, 1.2, 1], opacity: [0.25, 0.35, 0.25], rotate: [0, 45, 0] }}
    ...
    <motion.div
      ...
      animate={{ scale: [1, 1.1, 1], opacity: [0.2, 0.25, 0.2], rotate: [0, -30, 0] }}
  ...
  <div className="container mx-auto px-4 md:px-8 relative z-20">
    <div className="max-w-4xl mx-auto text-center">
      ...
      >
        <span className="text-white mb-4 block">Intelligent Client Retention for</span>
        <span
      ...
      >
        Our technology adapts to the unique client communication needs of various legal specialties
      </motion.p>
      ...
      >
        {/* tile 1 */}
        <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px]
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Capture Every Client</h3>
          <p className="text-sm text-white/70">24/7 AI-powered intake</p>
        </div>
        ...
        <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px]
          ...
          <h3 className="text-lg font-semibold text-white mb-2 text-center">Streamline Communication</h3>
          <p className="text-sm text-white/70 text-center">Reduce routine inquiries</p>
        </div>
        ...
        <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px]
                        ...
                        shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(0,0,0,0.1)]
                        group transform-gpu transition-all duration-500 hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_0_30px_rgba(0,0,0,0.2)]">
          <h3 className="text-lg font-semibold text-white mb-2 text-center">Boost Retention</h3>
          <p className="text-sm text-white/70 text-center">Increase client satisfaction</p>
        </div>
        ...
        <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px]
                        ...
                        shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(0,0,0,0.1)]
                        group transform-gpu transition-all duration-500 hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_0_30px_rgba(0,0,0,0.2)]">
          <h3 className="text-lg font-semibold text-white mb-2 text-center">Maximize Efficiency</h3>
          <p className="text-sm text-white/70 text-center">Automate repetitive tasks</p>
        </div>
        ...
        <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px]
          ...
          <h3 className="text-lg font-semibold text-white mb-2 text-center">Grow Your Practice</h3>
          <p className="text-sm text-white/70 text-center">Scale without increasing staff</p>
        </div>
      </motion.div>
    </div>
  </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 tracking-[-0.03em] leading-[1.1]">
                  <span className="text-white">Select your practice area to see how</span>
              ...
              >
                <AnimatePresence mode="wait">
                  {filteredAreas.map((area, index) => (
                    ...
                    >
                      <div className="relative h-full rounded-[2rem] overflow-hidden backdrop-blur-xl
                                    bg-gradient-to-br from-white/10 via-white/[0.07] to-transparent
                                    border border-white/10
                                    shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(0,0,0,0.1)]
                        ...
                        <div className="relative p-6 flex flex-col h-full">
                          ...
                          {/* Tagline */}
                          <p className="text-white/70 text-sm mb-6 flex-grow">{area.tagline}</p>
                          
                          {/* Quick Stats */}
                          <div className="grid grid-cols-3 gap-2 mb-6">
                            <div className="text-center p-2 rounded-lg bg-white/5">
                              <div className="text-accent text-sm font-semibold">{area.stats.retention}</div>
                              <div className="text-white/60 text-xs">Retention</div>
                            </div>
                            <div className="text-center p-2 rounded-lg bg-white/5">
                              <div className="text-accent text-sm font-semibold">{area.stats.timeSaved}</div>
                              <div className="text-white/60 text-xs">Saved</div>
                            </div>
                            <div className="text-center p-2 rounded-lg bg-white/5">
                              <div className="text-accent text-sm font-semibold">{area.stats.satisfaction}</div>
              ...
              >
                ...
                <div className="p-8 md:p-10">
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      <h3 className="text-3xl font-semibold text-white mb-2">{selectedArea.title}</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="relative p-6 rounded-[1.5rem] bg-gradient-to-br from-red-500/10 to-red-500/5 border border-red-500/20">
                      ...
                      <ul className="space-y-3">
                        {selectedArea.challenges.map((challenge: string, i: number) => (
                    ...
                    <div className="relative p-6 rounded-[1.5rem] bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/20">
                      ...
                      <ul className="space-y-3">
                        {selectedArea.solutions.map((solution: string, i: number) => (
                          <li key={i} className="flex items-start gap-3 text-white/80">
                  ...
                  {/* Success Story */}
                  <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl
                                bg-gradient-to-br from-accent/20 via-accent/10 to-accent/5
                                border border-accent/30 mb-8">
                    <p className="text-white/90 italic mb-3 text-lg">"{selectedArea.testimonial}"</p>
                    <p className="text-white font-medium">— {selectedArea.author}</p>
                  </div>
                  
                  {/* CTA */}
                  <div className="flex flex-col sm:flex-row gap-4">
                    <a 
                      href={`/demo-request?practice=${selectedArea.id}`}
                    ...
                    >
                      ...
                      <span className="relative text-white">Request a Demo Tailored for {selectedArea.title}</span>
