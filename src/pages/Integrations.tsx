...
import { ArrowRight, CheckCircle2, Database, MessageSquare, Phone, FileText } from 'lucide-react';
...
const Integrations: React.FC = () => {
  const crmIntegrations = [
    ...
    { name: "SmartAdvocate Integration", description: "Direct connection to case data" },
    { name: "Custom Integrations", description: "Tailored connections for proprietary systems" }
  ];

  const caseManagementIntegrations = [
    { name: "Law Ruler Connector", description: "Two-way sync with case data" },
    { name: "SmartAdvocate Integration", description: "Direct connection to case information" },
    { name: "Custom Integrations", description: "Tailored connections for proprietary systems" }
  ];

  const communicationIntegrations = [
    { name: "Email Integration", description: "Connects with your existing CRM and PM apps" },
    { name: "Text Messaging Enhancement", description: "Adds intelligence to SMS platforms" },
    { name: "Phone System Connection", description: "Integrates with current infrastructure" }
  ];
  ...
  return (
    <div className="min-h-screen bg-primary font-manrope">
      ...
      <main>
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Kayse enhances your current technology stack rather than replacing it
              </motion.p>
              ...
              >
                {/* tile 1 */}
                <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px] flex flex-col justify-center items-center
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">CRM Ready</h3>
                  <p className="text-sm text-white/70 text-center">Two-way sync</p>
                </div>
                ...
                <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px] flex flex-col justify-center items-center
                              ...
                              shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(0,0,0,0.1)]
                              group transform-gpu transition-all duration-500 hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_0_30px_rgba(0,0,0,0.2)]">
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">Case Mgmt</h3>
                  <p className="text-sm text-white/70 text-center">Instant connection</p>
                </div>
                ...
                <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px] flex flex-col justify-center items-center
                              ...
                              shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(0,0,0,0.1)]
                              group transform-gpu transition-all duration-500 hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_0_30px_rgba(0,0,0,0.2)]">
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">Comms Hub</h3>
                  <p className="text-sm text-white/70 text-center">Email / SMS / Voice</p>
                </div>
                ...
                <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px] flex flex-col justify-center items-center
                              ...
                              shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(0,0,0,0.1)]
                              group transform-gpu transition-all duration-500 hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_0_30px_rgba(0,0,0,0.2)]">
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">Secure Data</h3>
                  <p className="text-sm text-white/70 text-center">HIPAA-ready</p>
                </div>
                ...
                <div className="relative p-6 rounded-[1.5rem] overflow-hidden backdrop-blur-xl min-h-[140px] flex flex-col justify-center items-center
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">Open APIs</h3>
                  <p className="text-sm text-white/70 text-center">Future-proof</p>
                </div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <span className="relative text-white">Discuss Your Integration Needs</span>
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden" id="crm-integration">
          <div className="absolute inset-0">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-white/80 mb-8 leading-relaxed font-light">
                  Kayse works alongside your existing CRM, adding specialized features:
                </p>
                ...
                {/* Key Benefit */}
                <div className="mb-8 p-6 rounded-[1.5rem] backdrop-blur-xl
                  ...
                  <p className="text-white/90">Get specialized retention capabilities without replacing existing systems.</p>
                </div>

                {/* Client Quote */}
                <blockquote className="mb-8 p-6 rounded-[1.5rem] backdrop-blur-xl
                                     bg-gradient-to-br from-white/10 via-white/[0.07] to-transparent
                                     border-l-4 border-accent border-r border-t border-b border-white/10
                                     shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
                  <p className="text-white/90 italic mb-2">
                    "We invested heavily in our CRM, but it wasn't designed for legal client management. Kayse filled those gaps perfectly while leveraging our existing infrastructure."
                  </p>
                  <cite className="text-white/70 not-italic">— IT Director</cite>
                </blockquote>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-accent/20 via-transparent to-transparent rounded-[2rem] blur-2xl group-hover:from-accent/30 transition-all duration-500"></div>
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden" id="case-management">
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-block mb-4 px-6 py-2 rounded-xl bg-gradient-to-r from-white/10 via-white/[0.07] to-transparent backdrop-blur-md border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] transition-all duration-300">
                  <span className="text-white font-medium">Case Management Integration</span>
                </div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 tracking-[-0.03em] leading-[1.1]">
                  <span className="text-white">Seamless Connection to Your</span>
                  <span className="bg-gradient-to-r from-white via-[#3e9dff] via-[#3e9dff] to-white bg-clip-text text-transparent pl-2"
                        style={{
                          backgroundSize: "200% 100%",
                          backgroundPosition: "60% 0",
                ...
                <div className="mb-8 p-6 rounded-[1.5rem] backdrop-blur-xl
                              ...
                              border border-accent/30
                              shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
                  <p className="text-white font-semibold mb-2">Integration Timeframe:</p>
                  <p className="text-white/90">Typical integration takes 1 week depending on system complexity.</p>
                </div>
                ...
                <div className="mb-8 p-6 rounded-[1.5rem] backdrop-blur-xl
                              ...
                              shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
                  <p className="text-white font-semibold mb-2">Key Benefit:</p>
                  <p className="text-white/80">Maintain a single source of truth while adding retention capabilities.</p>
                </div>
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden" id="communication-systems">
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-block mb-4 px-6 py-2 rounded-xl bg-gradient-to-r from-white/10 via-white/[0.07] to-transparent backdrop-blur-md border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] transition-all duration-300">
                  <span className="text-white font-medium">Communication Systems</span>
                </div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 tracking-[-0.03em] leading-[1.1]">
                ...
                <div className="mb-8 p-6 rounded-[1.5rem] backdrop-blur-xl
                              ...
                              shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
                  <p className="text-white font-semibold mb-2">Key Benefit:</p>
                  <p className="text-white/90">Maintain familiar workflows while adding AI-powered capabilities.</p>
                </div>
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-[-0.03em] leading-[1.1] mb-6">
                    <span className="text-white">Ready to Enhance</span><br />
                  ...
                  <p className="text-xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
                    Let's discuss how Kayse can integrate with your existing systems to create a seamless client retention solution.
                  </p>
                </motion.div>
