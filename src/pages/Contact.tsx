...
<section className="relative py-24 sm:py-32 overflow-hidden">
  ...
  <div className="container mx-auto px-4 md:px-8 relative z-10">
    <div className="max-w-4xl mx-auto text-center">
      ...
      >
        Our team is ready to help you explore how our AI platform can transform your practice
      </motion.p>
    </div>
  </div>
</section>
        ...
        <section className="relative py-20 bg-black overflow-hidden" id="contact-form">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="max-w-2xl mx-auto">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
                  <div className="flex items-center gap-2">
                    ...
                    <a href="tel:+18666452973" className="text-white/80 hover:text-accent transition-colors">(866) 645-2973</a>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-5 h-5 text-accent" />
                    <span className="text-white/80">Monday-Friday, 8am-6pm ET</span>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.2 }}
              >
                <form onSubmit={handleSubmit} className="relative p-8 rounded-[2rem] overflow-hidden backdrop-blur-xl
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                      <label htmlFor="hearAbout" className="block text-white/80 mb-2 text-sm">How Did You Hear About Us?</label>
                      <select
                        id="hearAbout"
                        name="hearAbout"
                      ...
                      >
                        ...
                        <option value="Referral" className="bg-primary text-white">Referral from a Colleague</option>
                        <option value="Conference" className="bg-primary text-white">Conference or Event</option>
                        <option value="Legal Publication" className="bg-primary text-white">Legal Publication</option>
                        <option value="Other" className="bg-primary text-white">Other</option>
                      </select>
                    </div>
                    <div>
                      <label htmlFor="interestedIn" className="block text-white/80 mb-2 text-sm">What Are You Interested In?*</label>
                      <select
                        id="interestedIn"
                        name="interestedIn"
                      ...
                      >
                        <option value="" className="bg-primary text-white">Select an option</option>
                        <option value="Product Demo" className="bg-primary text-white">Product Demo</option>
                        <option value="Pricing Information" className="bg-primary text-white">Pricing Information</option>
                        <option value="Partnership" className="bg-primary text-white">Partnership Opportunities</option>
                        <option value="Technical Support" className="bg-primary text-white">Technical Support</option>
        ...
        {/* Quick Links Section */}
        <section className="relative py-20 bg-gradient-to-b from-black to-[#000a17] overflow-hidden" id="quick-links">
          <div className="absolute inset-0">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              >
                <h3 className="text-xl font-semibold mb-4 text-white">Schedule a Demo</h3>
